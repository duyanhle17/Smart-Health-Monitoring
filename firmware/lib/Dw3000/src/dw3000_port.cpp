...
void spiBegin(uint8_t irq, uint8_t rst)
{
  ...
  */
  ...
  SPI.begin();
#elif defined(DW3000_PIN_SCK) && defined(DW3000_PIN_MISO) && defined(DW3000_PIN_MOSI)
  // ESP32 custom pins (SafeWork): use pins passed via -DDW3000_PIN_*
  SPI.begin(DW3000_PIN_SCK, DW3000_PIN_MISO, DW3000_PIN_MOSI, DW3000_PIN_CS);
#else
  SPI.begin();
#endif
#ifndef ESP8266
